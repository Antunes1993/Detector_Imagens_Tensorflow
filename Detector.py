...
class Detector:
    ...
    def createBoundingBox(self, image, threshold):
        ...
        bboxIdx = tf.image.non_max_suppression(bboxs, classScores, max_output_size=5, iou_threshold=0.5, score_threshold=threshold)
